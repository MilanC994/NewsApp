...
const Error = ({ message }) => <div className='p-3 bg-dark rounded'> <h5 className='text-danger font-weight-bold'>{message}</h5></div>

const ArticlesContainer = () => {
  const { articles, getMoreData, shouldRenderLoadMoreButton, articlesLoading, articlesError, moreArticlesLoading, moreArticlesError } = useArticlesContainer()
